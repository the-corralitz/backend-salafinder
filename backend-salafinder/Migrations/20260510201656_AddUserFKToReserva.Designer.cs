...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("backend_salafinder.Models.Espacio", b =>
                {
                    b.Property<Guid>("id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.PrimitiveCollection<string>("programas_prioritarios")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<bool>("requiere_aprobacion")
                        .HasColumnType("bit");
                    ...
                    b.Property<DateTime>("ultima_vez_modificado")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("backend_salafinder.Models.Reserva", b =>
                {
                    ...
                    b.HasOne("backend_salafinder.Models.UsuarioPerfil", "usuario")
                        .WithMany()
            ...
            modelBuilder.Entity("backend_salafinder.Models.UsuarioPerfil", b =>
                {
                    b.HasOne("Microsoft.AspNetCore.Identity.IdentityUser", "identity_user")
                        .WithMany()
